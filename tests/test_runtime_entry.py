...
class RuntimeEntryTests(unittest.TestCase):
    ...
    def test_camera_target_uses_boot_progress_before_camera_session(self, boot_progress_mock) -> None:
        progress = MagicMock()
        ...
        progress.advance_to.assert_any_call(88, "Đang mở camera")
    ...
    @patch("app.runtime_entry.BootProgress")
    def test_ui_target_skips_boot_progress(self, boot_progress_mock) -> None:
        ...
        result = run_targeted_entrypoint(
            ...
            print_runtime_dashboard_fn=MagicMock(),
