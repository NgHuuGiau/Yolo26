...
class RunEntrypointsTests(unittest.TestCase):
    ...
    @patch("run_detect.select_runtime_config_optimized")
    @patch("run_detect.detect_hardware")
    @patch("run_detect.parse_args")
    def test_run_detect_main_wires_runtime_to_camera(self, parse_args_mock, detect_hardware_mock, select_runtime_mock, run_camera_mock) -> None:
    ...
    @patch("run_detect.detect_hardware")
    @patch("run_detect.parse_args")
    def test_run_detect_prompts_for_mode_when_not_provided(self, parse_args_mock, detect_hardware_mock, select_runtime_mock, run_camera_mock, prompt_mode_mock) -> None:
        ...
        self.assertEqual([call.kwargs["mode"] for call in select_runtime_mock.call_args_list], ["auto", "high", "medium", "low"])
    ...
    @patch("run_detect.detect_hardware")
    @patch("run_detect.parse_args")
    def test_run_detect_logs_helpful_error_when_runtime_fails(self, parse_args_mock, detect_hardware_mock, select_runtime_mock, _run_camera_mock, logger_mock) -> None:
    ...
    @patch("run_app.select_runtime_config_optimized")
    @patch("run_app.detect_hardware")
    @patch("run_app.prompt_runtime_mode", return_value="high")
    @patch("run_app.parse_args")
    def test_run_app_main_invokes_desktop_camera_flow(self, parse_args_mock, prompt_mode_mock, detect_hardware_mock, select_runtime_mock, run_camera_mock) -> None:
